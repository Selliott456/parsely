defmodule ParselyWeb.UserRegistrationLive do
  use ParselyWeb, :live_view

  alias Parsely.Accounts
  alias Parsely.Accounts.User
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      ...
      >
        ...
        <.input field={@form[:password]} type="password" label="Password" required phx-hook="PasswordStrength" />
  ...
  def mount(_params, _session, socket) do
    changeset = User.registration_changeset_with_confirmation(%User{}, %{})
  ...
  def handle_event("validate", %{"user" => user_params}, socket) do
    changeset = User.registration_changeset_with_confirmation(%User{}, user_params)
