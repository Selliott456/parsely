  ...
  def render(assigns) do
    ...
    <div class="min-h-screen">
          ...
          <div class="flex flex-col space-y-4 items-center justify-center w-full h-full">
                  <!-- Scan Business Card -->
        <.link navigate={~p"/scan-card"} class="w-[70vw] max-w-md bg-mint-primary/70 rounded-lg shadow-lg border border-mint-deep hover:shadow-xl transition-shadow duration-200 p-8 flex flex-col items-center justify-center text-center min-h-[40vh]">
