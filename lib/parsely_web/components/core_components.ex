defmodule ParselyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ParselyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ParselyWeb.Gettext, "errors", msg, opts)
    end
  end
